...
#        save_output(img_name_list[i_test],pred,prediction_dir)
        ...
        smoothgrad = smoothgrad[0][0] + smoothgrad[0][1] + smoothgrad[0][2]
        ...
        smoothgrad_sq = smoothgrad_sq[0][0] + smoothgrad_sq[0][1] + smoothgrad_sq[0][2]
...
#        smoothgrad_sq = torch.tensor(cmap[...,0])
        ...
        smoothgrad_i = smoothgrad_i[0][0] + smoothgrad_i[0][1] + smoothgrad_i[0][2]
        imshow(torchvision.utils.make_grid(VisualizeImageGrayscale(smoothgrad_i)))
        plt.axis('off')
        
        fig.add_subplot(length, width, 6).set_title('Smoothgrad^2 classification 0')
        smoothgrad_sq_i = smoothgrad_sq_i[0][0] + smoothgrad_sq_i[0][1] + smoothgrad_sq_i[0][2]
        imshow(torchvision.utils.make_grid(VisualizeImageGrayscale(smoothgrad_sq_i)))
        plt.axis('off')
