# U^2-Net (U square net) Attribution

Uses captum library to generate. To run Smoothgrad run u2net_test_maps_SG.py. To run Guided Backprop run u2net_test_guided_backprop.py.

Forked from the code from the paper **U^2-Net (U square net)** published in Pattern Recognition 2020:
